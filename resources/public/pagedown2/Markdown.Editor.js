...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttons.code = makeButton("wmd-code-button", "Code Sample - Ctrl+K", "icon-hdd", bindCommand("doCode"), group2);
            ...
            buttons.ulist = makeButton("wmd-ulist-button", "Bulleted List - Ctrl+U", "icon-th-list", bindCommand(function (chunk, postProcessing) {
                this.doList(chunk, postProcessing, false);
            }), group3);
            buttons.heading = makeButton("wmd-heading-button", "Heading - Ctrl+H", "icon-text-height", bindCommand("doHeading"), group3);
            buttons.hr = makeButton("wmd-hr-button", "Horizontal Rule - Ctrl+R", "icon-text-width", bindCommand("doHorizontalRule"), group3);
